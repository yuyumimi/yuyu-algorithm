---
{"dg-publish":true,"permalink":"/数据结构/双端队列/"}
---
...
![Pasted image 20240229214336.png](/img/user/pic/Pasted%20image%2020240229214336.png)

但如果存储的是引用类型，应当设置该位置的引用为 null，以便内存及时释放

![Pasted image 20240229214357.png](/img/user/pic/Pasted%20image%2020240229214357.png)